...
get_data_base <- function(xls_path=xls_path_){
...
get_data <- function(followup_2y_opts = TRUE, xls_path=xls_path_){
...
get_patients_with_complications_bf_6m <- function(){
  complication_data <- read_excel(xls_path_, sheet = 'Complications') %>% 
    as.data.table()
