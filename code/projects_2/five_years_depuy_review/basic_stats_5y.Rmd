...
clinical_data[, `Coronal Balance (C7PL to CSVL)` := as.numeric(`Coronal Balance (C7PL to CSVL)`)]
clinical_data[, `6W. Coronal Balance (C7PL to CSVL)` := as.numeric(`6W. Coronal Balance (C7PL to CSVL)`)]
clinical_data[, `2Y. Coronal Balance (C7PL to CSVL)` := as.numeric(`2Y. Coronal Balance (C7PL to CSVL)`)]
clinical_data[, `5Y. Coronal Balance (C7PL to CSVL)` := as.numeric(`5Y. Coronal Balance (C7PL to CSVL)`)]

clinical_data[, `Sagittal Balance` := as.numeric(`Sagittal Balance`)]
clinical_data[, `6W. Sagittal Balance` := as.numeric(`6W. Sagittal Balance`)]
clinical_data[, `2Y. Sagittal Balance` := as.numeric(`2Y. Sagittal Balance`)]
clinical_data[, `5Y. Sagittal Balance` := as.numeric(`5Y. Sagittal Balance`)]
