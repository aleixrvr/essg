...
for(outcome in outcomes){
  ...
  results_outcomes[[outcome]] <- calc_ate(
    ate_data, outcome, treatment_name=treatment_name, predictive_variates, first_visit=TRUE, tuneLenghtATE, modelsATE, incremental=TRUE, is_classification, repetitions
  )
}
```
...
```{r echo=FALSE, warning=FALSE, comment=""}
print_ates(treatment_name, outcome, results, is_classification, propensity_trim)
```
